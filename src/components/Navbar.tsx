...
export const Navbar = () => {
    return (
        <div className='grid grid-cols-2 gap-2 bg-gray-800 h-20 ' >
            ...
            <div>
                <div className='container flex flex-wrap items-center mx-auto mt-5'>
                    <Link className='text-lg hover:text-base text-red-200 font-bold' to="/"><h3>Home</h3></Link>
                    <Link className='text-lg hover:text-base text-red-200 font-bold ml-5' to="/addProduct"><h3>Add Product</h3></Link>
                </div>
            </div>
        </div>
    )
